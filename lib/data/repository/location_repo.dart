...
class LocationRepo {
  ...
  Future<Response> searchLocation(String keyText)async{
    return await apiClient.getData('${AppConstants.SEARCH_LOCATION_URI}?search_text=$keyText');
  }
  Future<Response> setLocation(String placeId)async{
    return await apiClient.getData('${AppConstants.SEARCH_LOCATION_URI}?placeid=$placeId');
  }
}
