...
Future<void> init()async{
  Get.lazyPut(() => ApiClient(baseUrl: AppConstants.BASE_URL)); // api client
  ...
  Get.lazyPut(() => RecommenededProductListController(recommendedProductRepo: Get.find())); // controller
}